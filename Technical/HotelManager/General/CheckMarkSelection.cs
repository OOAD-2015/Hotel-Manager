...
namespace HotelManager.General
{
    public class GridCheckMarksSelection
    {
        ...
        public System.Collections.ArrayList Selection
        {
        ...
        {
            if (View.FocusedColumn != column || e.KeyCode != Keys.Space || !column.OptionsColumn.AllowEdit) return;
        ...
        void View_Click(object sender, EventArgs e)
        {
            ...
            if (info.Column == column && info.Column.OptionsColumn.AllowEdit)
            {
                if (info.InColumn)
                {
